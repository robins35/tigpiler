...
struct
    ...
    | splitlast _ = ErrorMsg.impossible "WE HAVE FOUND AN UNEXPECTED TREE PATTERN!!!!!"
    ...
    fun trace(table,b as (T.LABEL lab :: _),rest) = 
        ...
        in 
            ...
            | _ => ErrorMsg.impossible "WE HAVE FOUND AN UNEXPECTED TREE PATTERN!!!!!"
         end
    | trace _ = ErrorMsg.impossible "WE HAVE FOUND AN UNEXPECTED TREE PATTERN!!!!!"
    ...
    and getnext(table,(b as (T.LABEL lab::_))::rest) = 
        ...
        | getnext _ = ErrorMsg.impossible "WE HAVE FOUND AN UNEXPECTED PATTERN!!!!!"
